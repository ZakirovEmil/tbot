...
public class TextMessages {
    public static final String START = "Привет, друг! Я знаю оценку твоей игры Metacritic";
    public static final String HELP = "Кнопка Metacritic, ищет игру по твоему запросу на Metacritic.";
    public static final String SERIES = "Версия";
